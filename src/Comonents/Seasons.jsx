  ...
  return (
    <div className="text-[white]">
      ...
      <div className="flex items-center mx-6 gap-2 ">
        ...
        ></i>
        <div
          className="ml-10  w-full  h-full overflow-x-scroll overflow-y-hidden whitespace-nowrap cursor-pointer
          ...
          {seasons.map((m, i) => (
            ...
            >
              <Link to={`/tv/${tvname.id}/${mid}/season/${m?.season_number}`}>
                <img
                  className={`mb-2 object-cover group-hover:scale-110 ease-in duration-300 h-52  `}
